...
export function ScrollToTop() {
  ...
  return (
    <div
      className={`fixed bottom-22 md:bottom-8 right-5 z-40 transition-all duration-300 transform ${
        isVisible
